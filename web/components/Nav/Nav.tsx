...
export const Nav = ({ navs, user }: NavProps) => {
                        ...
                        <nav className="hidden lg:flex lg:space-x-4 lg:pt-2" aria-label="Global">
                            {navs.map((item, index) => (
                                <Link
                                    ...
                                    href={ item.href }
                                    className={classNames(
                                        selected[index] ? 'text-gray-900 border-indigo-500' : 'border-transparent text-gray-500 text-black-900 hover:border-gray-200',
